...
TASK_ALIASES = {
    "CHECK-IN": "CHECK_IN", "CHECKIN": "CHECK_IN", "DAILY CHECK": "CHECK_IN",
    "FOLLOW": "FOLLOW_X", "FOLLOW X": "FOLLOW_X", "TWITTER FOLLOW": "FOLLOW_X",
    "JOIN DISCORD": "JOIN_DISCORD", "DISCORD": "JOIN_DISCORD",
    "JOIN TELEGRAM": "JOIN_TELEGRAM", "TELEGRAM": "JOIN_TELEGRAM",
    "BRIDGE": "BRIDGE", "SWAP": "SWAP", "STAKE": "STAKE",
    "NODE": "RUN_NODE", "RUN NODE": "RUN_NODE",
    "DEPLOY": "DEPLOY_CONTRACT", "DEPLOY CONTRACT": "DEPLOY_CONTRACT",
    "NFT": "MINT_NFT", "MINT NFT": "MINT_NFT", "CLAIM": "CLAIM",
}
